select count(*) as number_of_clients, avg(likelihoods.below_national_poverty_line),
avg(likelihoods.below_1_50_per_day_ppp_poverty_line), 
avg(likelihoods.below_2_00_per_day_ppp_poverty_line) 
from 
(select 
client_id,

...
class ActiveLoansLoanProductTest {

    def mfiName = 'Mifos HO'
    def reportName = 'Active Loans by Loan Product'
    ...
    def center = ['Loan Product:', 'loan prod 1'] 
    def details = ['32', 'br2 center 1', 'br2 group 1', 'br2 client 1 xxx', '3000.0000', '21.0000', '2010-07-21', '75.1000', '2.9000', '2924.9000', '18.1000', 'br2 LO xxx']
    def total = ['Total', '', '', '', '3000.0000', '21.0000', '', '75.1000', '2.9000', '2924.9000', '18.1000', '']
    ...
    void testParams_All_All_20110112() {
        new PrptReport().execute () { t ->
            ...
            // Report settings.
            t.reportPath = 'reports/standardReports/prpts/ActiveLoansLoanProduct.prpt'
            t.reportParams = ['selected_office': '-1', 'selected_product': '-1', 'out_date': '2011-01-12']
            ...
            t.assertRowEquals(5, ['Loan Product:', 'All'])

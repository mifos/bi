...
class LoanOfficerPerformanceSummaryDuringPeriodTest {
    ...
    void testParams_BO1_20100701_20100930() {
        new PrptReport().execute () { t ->
            ...
            def detailsDuringPeriod1 = ['br1 lo 1 smith', '2010-07-01', '21', '3', '12000.0000', '3252.9000', '17', '24', '391.0000', '341.0000', '0']
            def detailsDuringPeriod2 = ['br1 lo 2 xxx', '2010-07-04', '4', '0', '0.0000', '0.0000', '5', '2', '756.0000', '0.0000', '0']

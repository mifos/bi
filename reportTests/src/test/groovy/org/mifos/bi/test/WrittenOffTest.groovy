...
public class WrittenOffTest {
	...
	def detailsBO1_20100718 = ['center dw1', 'group dw1 2', 'client dw1 1 1 zeppelin', '000100000000004',  'loan prod 1', '2010-07-16', '"3, 000.00"', '2010-07-18', '"2, 752.90"', ' .00', 'go', 'br1 lo 1 smith']
	def GrouptotalBO1 = ['Group Total', '.', '"3, 000.00"', '"2, 752.90"', ' .00', '.']
	def CentertotalBO1 = ['Center Total', '.', '"3, 000.00"', '"2, 752.90"', ' .00', '.']
    def BranchtotalBO1 = ['Branch Total', '.', '"3, 000.00"', '"2, 752.90"', ' .00', '.']
	def grandTotalB01_20100701_20100815 = ['Grand Total', '.', '"3, 000.00"', '"2, 752.90"', ' .00', '.']

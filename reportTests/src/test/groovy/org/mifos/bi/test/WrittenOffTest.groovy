...
public class WrittenOffTest {
	...
	def detailsBO1_20100718 = ['center dw1', 'group dw1 2', 'client dw1 1 1 zeppelin', '000100000000004',  'loan prod 1', '2010-07-16', '3000.0000', '2010-07-18', '2752.9000', '00.0000', 'go', 'br1 lo 1 smith']
	def GrouptotalBO1 = ['Group Total', '.', '3000.0000', '2752.9000', '00.0000', '.']
	def CentertotalBO1 = ['Center Total', '.', '3000.0000', '2752.9000', '00.0000', '.']
    def BranchtotalBO1 = ['Branch Total', '.', '3000.0000', '2752.9000', '00.0000', '.']
	def grandTotalB01_20100701_20100815 = ['Grand Total', '.', '3000.0000', '2752.9000', '00.0000', '.']
